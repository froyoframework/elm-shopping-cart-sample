...
var _user$project$Cart$totalPrice = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Total: Rp 50000')
				]))
		]));
var _user$project$Cart$cartContent = A2(
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('image is-64x64')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$src('http://placehold.it/128x128'),
									_elm_lang$html$Html_Attributes$alt('product-1')
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))
						]))
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('media-content')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Product 1')
										]))
								])),
							A2(
							_elm_lang$html$Html$p,
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Rp 25000 x 1 pcs')
								])),
							A2(
							_elm_lang$html$Html$p,
							_elm_lang$core$Native_List.fromArray(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Total Price: Rp 25000')
								]))
						]))
				]))
		]));
var _user$project$Cart$parentContainer = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Shopping Cart')
						]))
				])),
			A2(
			_elm_lang$html$Html$div,
			...
			_elm_lang$core$Native_List.fromArray(
				[_user$project$Cart$cartContent])),
			_user$project$Cart$totalPrice
		]));

var _user$project$Types$Product = F3(
	function (a, b, c) {
		return {title: a, description: b, price: c};
	});
var _user$project$Types$Catalog = function (a) {
	return {item: a};
};
var _user$project$Types$Cart = F2(
	function (a, b) {
		return {item: a, subTotal: b};
	});
var _user$project$Types$DataFetched = function (a) {
	return {ctor: 'DataFetched', _0: a};
};
var _user$project$Types$ErrorOccurred = function (a) {
	return {ctor: 'ErrorOccurred', _0: a};
};
var _user$project$Types$FetchCatalog = {ctor: 'FetchCatalog'};
var _user$project$Types$Buy = {ctor: 'Buy'};

var _user$project$Catalog$productCard = function (model) {
	var showProduct = function (product) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('card card-product')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('image is-4by3')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$src('http://placehold.it/300x225'),
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('content card-product-content')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
	...
	return A2(
		...
		A2(_elm_lang$core$List$map, showProduct, model.item));
};
var _user$project$Catalog$parentContainer = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('column is-three-quarters')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Latest Products')
							])),
						_user$project$Catalog$productCard(model)
					]))
			]));
};

var _user$project$Parent$parentContainer = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Catalog$parentContainer(model),
				_user$project$Cart$parentContainer
			]));
};

var _user$project$Main$productInfoDecoder = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Types$Product,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'nama', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'deskripsi', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'harga', _elm_lang$core$Json_Decode$int));
var _user$project$Main$decodeProductsList = _elm_lang$core$Json_Decode$list(_user$project$Main$productInfoDecoder);
var _user$project$Main$fetchCatalogs = function () {
	var url = 'http://localhost:3000/data';
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Types$ErrorOccurred,
		_user$project$Types$DataFetched,
		A2(
			_elm_lang$core$Task$mapError,
			_elm_lang$core$Basics$toString,
			A2(_evancz$elm_http$Http$get, _user$project$Main$decodeProductsList, url)));
}();
		...
		switch (_p0.ctor) {
			...
			case 'FetchCatalog':
				return A2(
					...
					model,
					_elm_lang$core$Native_List.fromArray(
						[_user$project$Main$fetchCatalogs]));
			case 'ErrorOccurred':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
...
var _user$project$Main$init = function () {
	var model = {
		item: _elm_lang$core$Native_List.fromArray(
			[])
	};
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
	...
	main: _elm_lang$html$Html_App$program(
		{
			...
			view: _user$project$Parent$parentContainer,
